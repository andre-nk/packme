...
class ProfilePageDB extends StatefulWidget {
  @override
  _ProfilePageDBState createState() => _ProfilePageDBState();
}

class _ProfilePageDBState extends State<ProfilePageDB> {
  @override
  Widget build(BuildContext context) {
    ...
    // final ProfilePageDBData = Provider.of<List<UserProfileModel>>(context);
    // ProfilePageDBData.forEach((element) {
    //   //user avatar
